...
public:
    ...
    void static LocalBundleAdjustmentOnlyForRGBD(KeyFrame *pKF, bool *pbStopFlag, Map *pMap, int &num_fixedKF, int &num_OptKF, int &num_MPs, int &num_edges);

    int static PoseOptimization(Frame* pFrame);
    //!这里是自己写的仅仅适合RGBD相机的单帧位姿优化
